...
public class CodeGeneratorManager extends CodeGeneratorConfig {
     ...
     */
    public void genCodeWithSimpleName(String sign, String... tableNames) {
        genCodeByTableName(sign,true, tableNames);
    }
     ...
     * @param tableNames 表名, 可以多表
     */
    public void genCodeWithMultiTablesName(String sign, String... tableNames) {
        genCodeByTableName(sign, false, tableNames);
    }
     ...
     */
    public void genCodeWithCustomName(String sign, String tableName, String customModelName) {
        genCodeByTableName(sign, tableName, customModelName, false);
    }
...
//        }
    ...
    private  boolean isNotBlank(Object object){
        ...
        if(object instanceof CharSequence){
            ...
            return !List.class.cast(object).isEmpty();
        }
        else{
            return true;
        }
     ...
     */
    private void genCodeByTableName(String sign, boolean flag, String... tableNames) {
        for (String tableName : tableNames) {
            genCodeByTableName(sign, tableName, null, flag);
        }
    }
     ...
     * @param flag      标志
     */
    private void genCodeByTableName(String sign, String tableName, String modelName, boolean flag) {
        //获取表的区分字段
